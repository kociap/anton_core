...
namespace anton {
    ...
    template<typename T>
    [[nodiscard]] Reverse_Iterator<T> operator+(typename Reverse_Iterator<T>::difference_type n, Reverse_Iterator<T> const& a) {
        return Reverse_Iterator<T>(a.base() - n);
    }

    template<typename T1, typename T2>
    [[nodiscard]] auto operator-(Reverse_Iterator<T1> const& a, Reverse_Iterator<T2> const& b) -> decltype(b.base() - a.base()) {
        return b.base() - a.base();
    }

    template<typename T1, typename T2>
    [[nodiscard]] bool operator==(Reverse_Iterator<T1> const& a, Reverse_Iterator<T2> const& b) {
