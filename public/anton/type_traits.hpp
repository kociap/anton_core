...
// Since volatile has been deprecated in C++20, this implementation provides no
// traits for removing, adding or identifying volatile.

// is_swappable is defined in swap.hpp
