...
#define ANTON_DEFINE_CALL_CONST_REF_NOEXCEPT_QUALIFIERS(CLASS) ANTON_DEFINE_CALL_CONST_REF_QUALIFIERS(CLASS, )
...
#define ANTON_DEFINE_CONST_REF_NOEXCEPT_QUALIFIERS(CLASS) ANTON_DEFINE_CONST_REF_QUALIFIERS(CLASS, )
