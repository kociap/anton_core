...
namespace anton {
  ...
  [[nodiscard]] char8 ascii_to_uppercase(char8);
  ...
  [[nodiscard]] inline bool operator!=(UTF8_Char_Iterator const& a,
                                       UTF8_Char_Iterator const& b)
  {
    return !(a == b);
  }
  ...
  // This operation is linear in n.
  [[nodiscard]] inline UTF8_Char_Iterator
  operator+(UTF8_Char_Iterator a, UTF8_Char_Iterator::difference_type n)
  {
    a += n;
    return a;
  }
  ...
  // This operation is linear in n.
  [[nodiscard]] inline UTF8_Char_Iterator
  operator+(UTF8_Char_Iterator::difference_type n, UTF8_Char_Iterator a)
  {
    a += n;
    return a;
  }
  ...
  [[nodiscard]] inline UTF8_Char_Iterator::difference_type
  operator-(UTF8_Char_Iterator const& lhs, UTF8_Char_Iterator rhs)
  {
