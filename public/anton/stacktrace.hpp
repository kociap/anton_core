...
namespace anton::stacktrace {
    ...
    // Using it from a different process than the one it was first called from will result in
    // undefined behaviour.
    //
    // This function allocates memory, therefore it is highly unadvisable to call it in critical
    // situations, such as signal handlers.
    //
