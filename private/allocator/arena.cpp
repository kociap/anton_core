...
namespace anton {
    ...
    Arena_Allocator::Arena_Allocator(i64 const default_block_size, i64 const default_block_alignment)
        : default_block_size(default_block_size), default_block_alignment(anton::math::max(default_block_alignment, (i64)alignof(Block))) {}

    Arena_Allocator::Arena_Allocator(Arena_Allocator&& allocator)
        : first(allocator.first), last(allocator.last), default_block_size(allocator.default_block_size),
