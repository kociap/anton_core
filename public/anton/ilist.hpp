...
namespace anton {
    ...
    //
    template<typename T>
    void ilist_insert_before(IList_Node<T>* const position, IList_Node<T>* const node) {
    ...
    //
    template<typename T>
    void ilist_insert_after(IList_Node<T>* const position, IList_Node<T>* const node) {
    ...
    public:
        ...
        [[nodiscard]] operator IList_Iterator<Node_Type const, Base_Node_Type const>() const {
            return node;
        }
    ...
    public:
        ...
        using const_iterator = IList_Iterator<node_type const, base_node_type const>;
    ...
    template<typename Node, typename Tag>
    auto IList<Node, Tag>::insert(const_iterator position, base_node_type& node) -> iterator {
