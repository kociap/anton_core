...
namespace anton {
  Input_String_Stream::Input_String_Stream(String_View string)
    : _string(string), _current(_string.chars_begin())
  {
  }
  Input_String_Stream::Input_String_Stream(String string)
    : _string(ANTON_MOV(string)), _current(_string.chars_begin())
  {
  }
  ...
  void Input_String_Stream::seek(Seek_Dir dir, i64 offset)
  {
    if(dir == Seek_Dir::beg) {
      ...
      _current =
        UTF8_Char_Iterator{begin.get_underlying_pointer() + offset, offset};
    }
  }
