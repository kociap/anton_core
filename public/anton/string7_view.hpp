...
namespace anton {
  ...
  public:
    ...
    constexpr String7_View(value_type const* str, size_type size)
    ...
    constexpr String7_View(value_type const* first, value_type const* last)
    ...
    [[nodiscard]] constexpr value_type operator[](size_type const index) const
    {
      if constexpr(ANTON_ITERATOR_DEBUG) {
        ANTON_FAIL(index < _end - _begin && index >= 0,
                   u8"index out of bounds");
      }
  ...
  inline namespace literals {
    [[nodiscard]] constexpr String7_View operator""_sv7(char8 const* literal,
                                                        u64 size)
    {
  ...
  // Compares bytes
  [[nodiscard]] constexpr bool operator==(String7_View const& lhs,
                                          String7_View const& rhs)
  {
  ...
  // is not present.
  //
  [[nodiscard]] constexpr i64 find_substring(String7_View const string,
                                             String7_View const substr)
  {
    // Bruteforce
  ...
  // is not present.
  //
  [[nodiscard]] constexpr i64 find_last_substring(String7_View const string,
                                                  String7_View const substr)
  {
    // Bruteforce
    char8 const* const string_data = string.data();
  ...
  //
  [[nodiscard]] constexpr bool begins_with(String7_View const string,
                                           String7_View const substr)
  {
  ...
  //
  [[nodiscard]] constexpr bool ends_with(String7_View const string,
                                         String7_View const substr)
  {
